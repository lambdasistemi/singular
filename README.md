...
The Nix-built documentation archive is a review bundle, not a released protocol artifact. It contains the rendered site, raw model and corpus files, the naming contract, scenarios, replay sources, pinned toolchain inputs, exact identity ledgers, and an internal `artifacts/SHA256SUMS` manifest. [Build and release details](docs/building.md) explain how to reproduce it; no tag or publication is authorized by this candidate.
