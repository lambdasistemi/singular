# Connected cancellation acceptance
...
```mermaid
stateDiagram-v2
  [*] --> Pending: Atomic registration
  Pending --> Active: Connected fold
  Pending --> Cancelled: Certified cancellation during Retract window
  Cancelled --> [*]: Request and claim consumed
```
