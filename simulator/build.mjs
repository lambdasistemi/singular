...
const js=[module('core.mjs'),module('actions.mjs'),module('properties.mjs'),`const STORIES=${read('stories.json')};const CORPUS=${read('corpus.json')};const THEOREMS=${read('formal/theorem-debt.json')};const IDENTITY=${read('identity.json')};`,read('template-generic.js'),read('page.mjs')].join('\n');
