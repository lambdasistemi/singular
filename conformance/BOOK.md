...
Code revision: `9a3403eb5fc425c6dd1abc32d837dcd66cb0126f` (clean working tree).
...
Unnamed sequence compared 8 requests: 6 accepted and 0 refused on chain.
...
```text
unattributed node rejection: HardForkApplyTxErrFromEra S (S (S (S (S (S (Z (WrapApplyTxErr {unwrapApplyTxErr = ConwayApplyTxError (ConwayUtxowFailure (UtxoFailure (ValueNotConservedUTxO Mismatch (RelEQ) {supplied: MaryValue (Coin 29999999314039234) (MultiAsset (fromList [(PolicyID {policyID = ScriptHash "67ef82d1e5f6a4c3fcf95ac3dcd4aeccbdb6f0e9849cc63b0286ab20"},fromList [("8d4dc2ba84df9eb93aaf535a0a214597e7604ea7a3601d5a3e16900578ffa634",1)]),(PolicyID {policyID = ScriptHash "7a9e1742831da087e14275f99552ef8cc825ad7f6c30d309abe100f9"},fromList [("c68206c63316bc6c934e6e97a18c258d5206876837da21e34ff05d68c448c0ca",1)])])), expected: MaryValue (Coin 29999999314039234) (MultiAsset (fromList [(PolicyID {policyID = ScriptHash "30b54c79715efe593e7a840a833fee3b3c19f3a202610f8671cd54eb"},fromList [("73657175656e63652d646972656374",1)]),(PolicyID {policyID = ScriptHash "67ef82d1e5f6a4c3fcf95ac3dcd4aeccbdb6f0e9849cc63b0286ab20"},fromList [("8d4dc2ba84df9eb93aaf535a0a214597e7604ea7a3601d5a3e16900578ffa634",1)]),(PolicyID {policyID = ScriptHash "7a9e1742831da087e14275f99552ef8cc825ad7f6c30d309abe100f9"},fromList [("c68206c63316bc6c934e6e97a18c258d5206876837da21e34ff05d68c448c0ca",1)])]))})) :| [])})))))))
```
