module Cardano.MPFS.Cage.CandidateSpec (spec) where

import Cardano.MPFS.Cage.Candidate (CandidateSource (..), resolveCandidate, sourceName)
...
spec :: Spec
spec = describe "Cardano.MPFS.Cage.Candidate" $ do
