...
write('results.json',{schema:'singular-consumer-registration-results-v1',rows:ids.map(id=>({id,expected:'NOT-RUN',observed:'NOT-RUN',stage:'NOT-EXECUTED',purpose:'NOT-EXECUTED',evidence:['does-not-exist.log']}))});
