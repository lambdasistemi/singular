...
The builder and blueprint modules now have a contributor map: which module
owns script identity, lookups, balancing, edge decisions and blueprint
parameter work, where common edits land, and which decisions the extraction
recorded. It is [Builder and blueprint modules](offchain-builder-blueprint.md).
