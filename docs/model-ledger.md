...
| R6 | release removes application UTxO; escape always refused; completion consumes request and burns coupled NFT | Modeled; supply and single-spend guarantees STATED |
