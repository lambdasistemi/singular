...
* **177:** observe the retirement live as conformance row CG22 ([056cf9b](https://github.com/lambdasistemi/singular/commit/056cf9b6a8b7e016feffd705b67c993aad2e93f4))
* **177:** reference the state validator at boot and restore the full guard ([e71e893](https://github.com/lambdasistemi/singular/commit/e71e893d852388eab2ba5fc49ed1055ced851259))
* **177:** refuse a retirement by name instead of dying in the library ([aed74e2](https://github.com/lambdasistemi/singular/commit/aed74e213a007bec6fd1a3b7b70a196c0fcab6e2))
* **177:** run the retirement from the extracted archive ([3a6aa25](https://github.com/lambdasistemi/singular/commit/3a6aa25dd205289213e242386d97478c882237f3))
* **177:** source the retirement's burn from the holder that carries it ([a4e86e4](https://github.com/lambdasistemi/singular/commit/a4e86e4203d3e820ec8ca1c92a187588710e4d55))
...
* model the updateTerminal transaction row ([019e258](https://github.com/lambdasistemi/singular/commit/019e2584a67148d62d40b58a74f117763060d924))
...
* **model:** construct updateTerminal transaction row ([759ceba](https://github.com/lambdasistemi/singular/commit/759cebae38612a9b25bf727726d708778416810d))
...
* **177:** carry the rebased receipt fields on CG21 and the CG22 refusal legs ([7b75a4e](https://github.com/lambdasistemi/singular/commit/7b75a4e5e6e8fa81c43e444c01c3a677daaee6d2))
* **177:** fit the retirement guard inside the boot transaction ([c848855](https://github.com/lambdasistemi/singular/commit/c848855aabfaa286dc30075d6e67fd3d65727850))
* **177:** suppress the CG22 shellcheck finding, name the refused keys, resolve boot by reference ([c9afb2d](https://github.com/lambdasistemi/singular/commit/c9afb2d132921739855ac549e4dd5155d2379225))
...
* **177:** say which control belongs to which refusal ([98f0ac4](https://github.com/lambdasistemi/singular/commit/98f0ac4203c6d8e78f1a5d19546212ddc102bb00))
...
* **177:** tell shellcheck the frozen jq body is not shell ([c1d5eff](https://github.com/lambdasistemi/singular/commit/c1d5eff710c8456563abdd140e9530c9f2403986))
